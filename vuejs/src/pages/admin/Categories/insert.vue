<template>
  <div class="container-fluid px-3 px-md-4">
    <div class="d-flex justify-content-between align-items-center flex-wrap">
      <h3 class="text-danger fw-bold mb-2 mb-md-0">Thêm món ăn</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 mb-3">
                ...
                <select class="form-select rounded-0" id="status" required>
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control rounded-0" id="description" rows="6"></textarea>
            </div>
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <div class="mt-3 p-2 text-center">
                <img src="/img/food/cb1.webp" class="img-fluid w-75">
              </div>
            </div>
          </div>
        </div>
