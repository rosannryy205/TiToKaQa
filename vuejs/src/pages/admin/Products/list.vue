        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="toppingName" class="form-label">
                        Giá món <span class="text-danger">*</span>
                    </label>
                    <input type="number" class="form-control mb-3" placeholder="Nhập giá" />
                    ...
                    <input type="number" class="form-control mb-3" placeholder="Nhập số lượng" />
                    <label for="toppingName" class="form-label">
                        Hình ảnh <span class="text-danger">*</span>
                    </label>
                    <input type="file" class="form-control mb-3" placeholder="Nhập số lượng" />
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
