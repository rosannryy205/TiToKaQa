    ...
    public function run(): void
    {
        DB::table('discounts')->insert([
            ...
            [
                ...
                'usage_limit' => 300,
                'used' => 0,
                'source' => 'point_exchange','user_level' => null,
                'cost' => 1000,
            ...
            //lucky_wheel
                ...
                [
                    'code' => 'LUCKY5K',
                    'name' => 'Giảm 5.000đ cho đơn từ 30.000đ',
                    'discount_value' => 5000,
                    'discount_method' => 'fixed',
                    'discount_type' => 'salefood',
                    'category_id' => null,
                    ...
                    'usage_limit' => 200,
                    'used' => 0,
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Nhận từ vòng quay may mắn – áp dụng đơn từ 30k.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'LUCKYFREESHIP',
                    'name' => 'Miễn phí 15k vận chuyển đơn từ 70k',
                    'discount_value' => 15000,
                    'discount_method' => 'fixed',
                    'discount_type' => 'freeship',
                    'category_id' => null,
                    ...
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Giảm tối đa 15.000đ phí vận chuyển đơn từ 70k.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'LUCKY10PERCENT',
                    'name' => 'Giảm 10% tổng đơn – tối đa 20k',
                    'discount_value' => 10,
                    'discount_method' => 'percent',
                    'discount_type' => 'salefood',
                    'category_id' => null,
                    ...
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Giảm 10% đơn hàng, tối đa 20.000đ.',
                    'custom_condition_note' => 'Chỉ áp dụng cho đơn từ 50.000đ.',
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'LUCKY50PERCENT',
                    'name' => 'Giảm 50% tối đa 25.000đ',
                    'discount_value' => 50,
                    'discount_method' => 'percent',
                    'discount_type' => 'salefood',
                    'category_id' => null,
                    ...
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Giảm một nửa hóa đơn cho đơn từ 60k.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'LUCKYSHIPFREE',
                    'name' => 'Free ship khu vực HCM tối đa 20k',
                    'discount_value' => 20000,
                    'discount_method' => 'fixed',
                    'discount_type' => 'freeship',
                    'category_id' => null,
                    ...
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Miễn phí vận chuyển tối đa 20k cho đơn từ 80k.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'LUCKY90K',
                    'name' => 'Giảm 90.000đ cho đơn trên 500k',
                    ...
                    'source' => 'lucky_wheel','user_level' => null,
                    'cost' => 0,
                    'condition' => 'Dành cho đơn giá trị lớn – giảm mạnh 90.000đ!',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                ...
                [
                    'code' => 'SHIP10KNEW',
                    'name' => 'Tặng 10k phí ship cho người mới',
                    'discount_value' => 10000,
                    'discount_method' => 'fixed',
                    'discount_type' => 'freeship',
                    'category_id' => null,
                    ...
                    'user_level' => 'new',
                    'cost' => 0,
                    'condition' => 'Áp dụng cho đơn từ 50.000đ. Giảm 10.000đ phí ship.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],  
                [
                    ...
                    'user_level' => 'silver',
                    'cost' => 0,
                    'condition' => 'Áp dụng cho đơn từ 50.000đ. Giảm 20.000đ phí ship.',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],    
                [
                    'code' => 'FOOD50KGOLD',
                    'name' => 'Giảm 50.000đ cho đơn trên 100k',
                    'discount_value' => 50000,
                    'discount_method' => 'fixed',
                    'discount_type' => 'salefood',
                    'category_id' => null,
                    ...
                    'user_level' => 'gold',
                    'cost' => 0,
                    'condition' => 'Dành cho đơn giá trị lớn – giảm mạnh 50.000đ!',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
                [
                    'code' => 'FOOD100KDIAMOND',
                    'name' => 'Giảm 100.000đ cho đơn trên 100k',
                    ...
                    'user_level' => 'diamond',
                    'cost' => 0,
                    'condition' => 'Dành cho đơn giá trị lớn – giảm mạnh 100.000đ!',
                    'custom_condition_note' => null,
                    'created_at' => now(),
                    'updated_at' => now(),
                ],
