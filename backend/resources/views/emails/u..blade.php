<div style="max-width: 600px; margin: auto; font-family: Arial, sans-serif; border: 1px solid #ddd; padding: 20px; background-color: #fff8f0;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding: 8px;">Mì cay hải sản</td>
                <td style="padding: 8px; text-align: center;">Cấp 3</td>
                <td style="padding: 8px; text-align: center;">1</td>
                <td style="padding: 8px; text-align: right;">55.000đ</td>
            </tr>
            @endforeach
    ...
    <p style="margin-top: 20px;">Trân trọng,<br><strong>🍜 Mì Cay {{ten_quan}}</strong></p>
</div>
