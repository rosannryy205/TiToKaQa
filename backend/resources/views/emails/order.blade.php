<div
    ...
    <div style="padding: 0 30px 30px 30px;">
        <div style="font-size: 14px; color: #777777; margin-bottom: 25px;">
            ...
            <div>
                Cảm ơn bạn đã đặt món tại <span style="color: #c92c3c">TikTokaQa</span>! Đơn hàng và thông tin
                đặt bàn của bạn đã được xác nhận. Chúng tôi sẽ gửi một email khác khi đơn của bạn đang được giao đi.
            </div>
        </div>
        ...
        <div style="border-top: 1px solid #e8e8e8; padding-top: 25px; text-align: center;">
            ...
            <br>
            @if ($mailData['order_status'] == 'Đang giao hàng')
            <a href="http://localhost:5173/delivery/{{ $mailData['order_id'] }}"
